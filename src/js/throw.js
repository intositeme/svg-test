...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        "use strict";
        _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenMax", "easing.Ease", "utils.VelocityTracker"], function(a, b, c, d) {
        ...
        }, !0), _gsScope._gsDefine("utils.VelocityTracker", ["TweenMax"], function(a) {
            var b, c, d, e, f = /([A-Z])/g,
                g = {},
                h = {
                    x: 1,
    ...
    function(a) {
        ...
        "function" == typeof define && define.amd ? define(["TweenMax"], b) : "undefined" != typeof module && module.exports && (require("gsap"), module.exports = b())
    }("ThrowPropsPlugin");